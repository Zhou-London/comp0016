    ...
    return (
        <section className={styles.section}>
            ...
            <div style={{ maxWidth: '1100px', margin: '0 auto', display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                ...
                {/* Design Principles */}
                <Reveal className="persona-slide-left">
                ...
                <Reveal className="table-reveal">
                    <div className={styles.abstractPanel}>
                        ...
                        <Reveal delay={100} className="goal-roll-in">
                ...
                {/* Prototypes */}
                <Reveal className="persona-slide-right">
                    <div className={styles.abstractPanel}>
                ...
                <Reveal className="table-reveal">
                    <div className={styles.abstractPanel}>
                            ...
                            <div style={{ display: 'flex', gap: '2rem', marginTop: '2rem', alignItems: 'flex-start' }}>
                                ...
                                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, auto)', gap: '1rem', flex: 1 }}>
                                    {[
                                        ...
                                        <div key={hex} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '0.15rem' }}>
                                            <div style={{ width: '140px', height: '50px', borderRadius: '10px', background: hex, border: '1px solid #dde7f3', boxShadow: '0 2px 8px rgba(0,0,0,0.1)' }} />
                                            <span style={{ fontSize: '0.8rem', fontWeight: 600, color: 'var(--slate-700)' }}>{label}</span>
                                            <span style={{ fontSize: '0.75rem', color: 'var(--slate-500)', fontFamily: 'monospace' }}>{hex}</span>
                                        </div>
                                    ))}
                                </div>
                            </div>
                        ...
                        <Reveal delay={180} className="fade-in-scale">
                            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '2.5rem', marginTop: '2rem' }}>
                        ...
                        <Reveal delay={140} className="fade-in-scale">
                        ...
                        <Reveal delay={80} className="goal-roll-in">
                        ...
                        <Reveal delay={160} className="fade-in-scale">
