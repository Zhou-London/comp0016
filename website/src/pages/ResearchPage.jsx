    ...
    <section className={styles.sectionAlt}>
      ...
      <div style={{maxWidth: '1100px', margin: '0 auto', display: 'flex', flexDirection: 'column', gap: '1.5rem'}}>
        ...
        <div className={styles.abstractPanel}>
          ...
          <p style={{marginTop: '0.5rem'}}>[4] EA Sports, "FIFA Trainer: Learn to Play," 2024. [Online]. Available: <a href="https://www.ea.com/games/fifa/fifa-23/news/fifa-trainer" target="_blank" rel="noopener noreferrer">https://www.ea.com/games/fifa/fifa-23/news/fifa-trainer</a></p>
          ...
          <p style={{marginTop: '0.5rem'}}>[7] Unity Asset Store, "Soccer Game Template," 2024. [Online]. Available: <a href="https://assetstore.unity.com/packages/templates/packs/soccer-game-template-155866" target="_blank" rel="noopener noreferrer">https://assetstore.unity.com/packages/templates/packs/soccer-game-template-155866</a></p>
          <p style={{marginTop: '0.5rem'}}>[8] MotionInput, "MotionInput API Documentation," 2024. [Online]. Available: <a href="https://motioninput.com/docs" target="_blank" rel="noopener noreferrer">https://motioninput.com/docs</a></p>
